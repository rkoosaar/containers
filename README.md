...
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/rkoosaar/containers/release.yaml?style=for-the-badge&label=Release)

</div>

Welcome to our container images! If you are looking for a container, start by [browsing the GitHub Packages page for this repository's packages](https://github.com/orgs/rkoosaar/packages?repo_name=containers).
...
| Container | Immutable |
|-----------------------|----|
| `ghcr.io/rkoosaar/home-assistant:rolling` | ❌ |
| `ghcr.io/rkoosaar/home-assistant:2025.5.1` | ❌ |
| `ghcr.io/rkoosaar/home-assistant:rolling@sha256:8053...` | ✅ |
| `ghcr.io/rkoosaar/home-assistant:2025.5.1@sha256:8053...` | ✅ |
...
services:
  home-assistant:
    image: ghcr.io/rkoosaar/home-assistant:2025.5.1
...
```sh
gh attestation verify --repo rkoosaar/containers oci://ghcr.io/rkoosaar/${APP}:${TAG}
```
...
cosign verify-attestation --new-bundle-format --type slsaprovenance1 \
    ...
    --certificate-identity-regexp "^https://github.com/rkoosaar/containers/.github/workflows/app-builder.yaml@refs/heads/main" \
    ghcr.io/rkoosaar/${APP}:${TAG}
```
...
- **qBittorrent** is only published with **LibTorrent 2.x**. See [this issue](https://github.com/rkoosaar/containers/issues/848) for more information.
...
2. **Renovate Configuration**: Configuration files are located in the [`.github`](https://github.com/rkoosaar/.github) and [renovate-config](https://github.com/rkoosaar/renovate-config) repositories.
